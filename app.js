...
// ✅ USAR REPETIDA (SALIDA CONTROLADA)
  ...
  for(let eq in repetidas){
    ...
    for(let n in repetidas[eq]){
      ...
      <div class="lamina repetida">
        ${n}
        ${info.intercambio?`🔁(${info.intercambio})`:``}
...
// ✅ INTERCAMBIO (SOLO USA INTERCAMBIO)
